...
This is an independently maintained port, built as a full-stack engineering portfolio piece — see [`architect.md`](../architect.md) for how it's put together and [`todo.md`](../todo.md) for current status.
...
- **Self-host:** Run locally or on your own infrastructure.
...
- [Architecture Overview](../architect.md) and [Progress / TODO](../todo.md)
- [Project wiki](https://github.com/Terrence721/directus-main/wiki)
- [Scrum board](https://github.com/users/Terrence721/projects/6)
- [GitHub Issues](https://github.com/Terrence721/directus-main/issues) (Report Bugs)
